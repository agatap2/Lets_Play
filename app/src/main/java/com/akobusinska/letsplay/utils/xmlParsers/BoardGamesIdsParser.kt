...
class BoardGamesIdsParser {

    @Throws(XmlPullParserException::class, IOException::class)
    fun readBoardGame(parser: XmlPullParser): BoardGamesSearchResult {
        parser.require(XmlPullParser.START_TAG, null, Tags.BOARD_GAME.fieldName)
